...
PROD_POSTGRES_PORT="${POSTGRES_PORT:-}"
PROD_POSTGRES_DB="${POSTGRES_DB:-}"
PROD_POSTGRES_USER="${POSTGRES_USER:-}"
PROD_POSTGRES_PASSWORD="${POSTGRES_PASSWORD:-}"
source_dotenv "$REPO_ROOT/.env.local"

PROD_SSH_HOST="${PROD_SSH_HOST:-${PROD_SSH:-${APP_HOST:-}}}"

PROD_DB_HOST="${PROD_DB_HOST:-${PROD_POSTGRES_HOST:-}}"
PROD_DB_PORT="${PROD_DB_PORT:-${PROD_POSTGRES_PORT:-}}"
PROD_DB_NAME="${PROD_DB_NAME:-${PROD_POSTGRES_DB:-}}"
PROD_DB_USER="${PROD_DB_USER:-${PROD_POSTGRES_USER:-}}"
PROD_DB_PASSWORD="${PROD_DB_PASSWORD:-${PROD_POSTGRES_PASSWORD:-}}"
